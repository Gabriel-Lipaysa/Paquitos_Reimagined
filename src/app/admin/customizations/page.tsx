...
export default function AdminCustomizationsRedirectPage() {
  return (
    <div style={{ maxWidth: '650px', margin: '4rem auto', textAlign: 'center', backgroundColor: '#fff', padding: '3rem 2rem', borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}>
      ...
      <p style={{ color: '#64748b', fontSize: '0.95rem', lineHeight: '1.6', marginBottom: '2rem' }}>
        Toppings, flavor levels, cheeses, and add-ons are now managed directly on individual items in the Product Catalog. This eliminates the need for separate image uploads for toppings and scales cleanly to any food department.
      </p>
